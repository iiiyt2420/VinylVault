void main() {
  const longPlayMinutes = 45;
  const moreTracksCount = 15;
  const lowerPrice = 4000.0;
  final price = 3240.0;
  ...
  final isLongPlay = timeSeconds > longPlayMinutes * 60;
  final canBuyNow = isAvailable && price < lowerPrice;
  final hasDiscount = isLongPlay || trackCount > moreTracksCount;
